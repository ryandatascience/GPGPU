/* ==================================================================
	...
	The improved SDH algorithm implementation for 3D data
...
//printf("args are %d and %f\n", PDH_acnt, PDH_res);
    ...
    memset(cuda_histogram,0,sizeof(bucket)*num_buckets);
	...
	// measure GPU run time, create event and record
	...
	/*run kernel*/
	SDHKernel<<<ceil(PDH_acnt+thread_number-1)/thread_number, thread_number>>>(d_atom_list,d_histogram,PDH_acnt,PDH_res);

	// measure GPU run time, stop event and record
